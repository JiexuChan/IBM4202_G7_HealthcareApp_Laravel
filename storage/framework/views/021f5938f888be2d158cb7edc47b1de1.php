            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-dashbord menu-active menu-icon-dashbord-active" >
                        <a href="<?php echo e(url('/admin/dashboard')); ?>" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Dashboard</p></a></div></a>
                    </td>
                </tr>
                <tr class="menu-row">
                            ...
                            <tr>
                                <td style="width: 25%;">
                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex">
                                        ...
                                        <div class="btn-icon-back dashboard-icons" style="background-image: url('<?php echo e(asset('img/icons/doctors-hover.svg')); ?>');"></div>
                                    </div>
                                </td>
                                <td style="width: 25%;">
                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex;">
                                        ...
                                        <div class="btn-icon-back dashboard-icons" style="background-image: url('<?php echo e(asset('img/icons/patients-hover.svg')); ?>');"></div>
                                    </div>
                                </td>
                                <td style="width: 25%;">
                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex; ">
                                        ...
                                        <div class="btn-icon-back dashboard-icons" style="margin-left: 0px;background-image: url('<?php echo e(asset('img/icons/book-hover.svg')); ?>');"></div>
                                    </div>
                                </td>
                                <td style="width: 25%;">
                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex;padding-top:26px;padding-bottom:26px;">
                                        ...
                                        <div class="btn-icon-back dashboard-icons" style="background-image: url('<?php echo e(asset('img/icons/session-iceblue.svg')); ?>');"></div>
                                    </div>
                                </td>
                            </tr>
                        </table>
                    ...
                    <td colspan="4">
                        <table width="100%" border="0" class="dashbord-tables">
                            <tr>
                                <td>
                                    <p style="padding:10px;padding-left:48px;padding-bottom:0;font-size:23px;font-weight:700;color:var(--primarycolor);">
                                        Upcoming Appointments until Next <?php echo e(now()->addWeek()->format('l')); ?>
                                ...
                                <td>
                                    <p style="text-align:right;padding:10px;padding-right:48px;padding-bottom:0;font-size:23px;font-weight:700;color:var(--primarycolor);">
                                        Upcoming Sessions until Next <?php echo e(now()->addWeek()->format('l')); ?>
                            ...
                            <tr>
                                <td width="50%">
                                    <center>
                                        ...
                                        <thead>
                                        <tr>    
                                            <th class="table-headin" style="font-size: 12px;">Appt. num</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="font-weight:600;"> &nbsp;
                                                    <?php echo e(substr($appointment->docname, 0, 25)); ?>

                                                </td>
                                                <td>
                                                    <?php echo e(substr($appointment->title, 0, 15)); ?>
                                            ...
                                            <tr>
                                                <td colspan="4">
                                                    ...
                                                    <br>
                                                    <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">We couldn't find anything related!</p>
                                ...
                                <td width="50%" style="padding: 0;">
                                    <center>
                                        ...
                                        <tbody>
                                            <?php $__empty_1 = true; $__currentLoopData = $upcoming_sessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                <td style="padding:20px;"> &nbsp;
                                                    <?php echo e(substr($session->title, 0, 30)); ?>

                                                </td>
                                                <td>
                                                    <?php echo e(substr($session->docname, 0, 20)); ?>
                            ...
                            <tr>
                                <td>
                                    <center>
                                        <a href="<?php echo e(url('/admin/appointments')); ?>" class="non-style-link"><button class="btn-primary btn" style="width:85%">Show all Appointments</button></a>
                                    </center>
                                </td>
                                <td>
                                    <center>
                                        <a href="<?php echo e(url('/admin/schedule')); ?>" class="non-style-link"><button class="btn-primary btn" style="width:85%">Show all Sessions</button></a>
                                    </center>
                                </td>
                            </tr>
                        </table>
...
</html><?php /**PATH C:\xampp\htdocs\HealthcareApp_Laravel\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>